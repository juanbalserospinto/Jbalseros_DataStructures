...
This program loads a CSV of soccer stadiums that includes stadiums from all over europe. The program initially provides you with the coordinates of the most known european cities to make it easier for you to pick your coordinates. After this, the program does the following: 
